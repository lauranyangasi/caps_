...
def encryption_function(input_text, key):
    ...
    for text in input_text:
        if text in alphabets:
            ...
            new_text_index = text_index - key
            if new_text_index >= len(alphabets):
                new_text_index -= len(alphabets)
            cipher_text += alphabets[new_text_index]
        else:
            cipher_text += text
    return cipher_text
encryption_function(input_text, key)
